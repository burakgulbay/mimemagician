/*
Package mimemagician implements MIME sniffing using pre-compiled glob
...
and run go generate:
  go:generate go run github.com/zRedShift/mimemagician/v2/cmd/parser /usr/share/mime/packages

To use the default freedesktop.org.xml file provided in this package:
  go:generate go run github.com/zRedShift/mimemagician/v2/cmd/parser cmd/parser
